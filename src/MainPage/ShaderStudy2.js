...
export default class ShaderStudy extends React.Component {
  ...
  draw() {
    ...
    // this.canvasTexture(renderer)
  }

  canvasTexture(renderer){
    ...
    let map = new THREE.CanvasTexture(getTextCanvas('Leo Test Label'));
    ...
    //   console.log('change', map.source.data.getContext('2d'));
    // }, 2000)
